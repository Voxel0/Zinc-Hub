...
local tracersColor = Color3.fromRGB(27, 33, 221)
local playerNamesColor = Color3.fromRGB(27, 105, 195)
...
local creditsSection = creditsPage:addSection("Made By Voxel#0002")
...
espColorsSection:addColorPicker("Tracers Color", Color3.fromRGB(176,224,230), function(value)
    tracersColor = value
end)
espColorsSection:addColorPicker("Player Names Color", Color3.fromRGB(176,224,230), function(value)
    playerNamesColor = value
end)
espColorsSection:addColorPicker("Boxes Color", Color3.fromRGB(176,224,230), function(value)
    boxesColor = value
end)
